...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkSessionViewModeTitle: '会话页面样式',
    coworkSessionViewModeHint: '选择使用经典会话页面，或新的会话页面样式。',
    coworkSessionViewModeLegacy: '经典会话',
    coworkSessionViewModeOpenClaw: '新会话',
    coworkOpenClawSessionDefaultModel: '默认模型',
    openclawSessionsCountSuffix: '个会话',
    openclawSessionSelectHint: '从左侧会话列表中选择一个会话查看历史消息。',
    openclawSessionLoadingHistory: '正在加载会话历史...',
    openclawSessionInputPlaceholder: '输入消息并继续当前会话',
    openclawSessionInputHint: '当前会话已切换到新的会话详情页',
    openclawSessionEmptyHint: '当前会话还没有可展示的历史消息，你可以在下方继续输入并开始新的交互。',
    openclawSessionModelHint: '直接填写 provider/model，留空则回退到默认模型。',
    openclawSessionSendPending: '发送链路下一步接入，本轮先完成详情页交互对齐。',
    openclawSessionSendFailed: '发送消息失败。',
    openclawSessionAbortFailed: '停止当前会话失败。',
    openclawSessionDeleteMainForbidden: '当前主会话不允许删除。',
    openclawSessionDeleteFailed: '删除会话失败。',
    openclawSessionAttachmentOnlyMessage: '[附件]',
    openclawSessionRunAborted: '本次运行已停止。',
    openclawSessionRunFailed: '本次运行失败。',
    openclawSessionRunErrorPrefix: '本次运行失败：',
    openclawSessionStateRunning: '生成中',
    openclawSessionStateStopping: '停止中',
  ...
  en: {
    ...
    coworkSessionViewModeTitle: 'Conversation Page Style',
    coworkSessionViewModeHint: 'Choose between the classic conversation page and the new conversation page style.',
    coworkSessionViewModeLegacy: 'Classic Conversation',
    coworkSessionViewModeOpenClaw: 'New Conversation',
    coworkOpenClawSessionDefaultModel: 'Default model',
    openclawSessionsCountSuffix: 'sessions',
    openclawSessionSelectHint: 'Select a session from the left sidebar to inspect its history.',
    openclawSessionLoadingHistory: 'Loading session history...',
    openclawSessionInputPlaceholder: 'Enter a message to continue this session',
    openclawSessionInputHint: 'This session is now shown in the new detail view',
    openclawSessionEmptyHint: 'This session does not have any displayable history yet. You can keep typing below to continue.',
    openclawSessionModelHint: 'Use provider/model directly. Leave it empty to fall back to the default model.',
    openclawSessionSendPending: 'Send wiring will be connected next. This round focuses on matching the detail interaction.',
    openclawSessionSendFailed: 'Failed to send the message.',
    openclawSessionAbortFailed: 'Failed to stop the current session.',
    openclawSessionDeleteMainForbidden: 'The main session cannot be deleted.',
    openclawSessionDeleteFailed: 'Failed to delete the session.',
    openclawSessionAttachmentOnlyMessage: '[Attachment]',
    openclawSessionRunAborted: 'The run was aborted.',
    openclawSessionRunFailed: 'The run failed.',
    openclawSessionRunErrorPrefix: 'The run failed: ',
    openclawSessionStateRunning: 'Generating',
    openclawSessionStateStopping: 'Stopping',
    coworkAgentEngineClaudeLegacy: 'Cowork',
