...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    // Security scan
    securityScanTitle: '安全扫描报告',
    securityRisk_safe: '安全',
    securityRisk_low: '低风险',
    securityRisk_medium: '中等风险',
    securityRisk_high: '高风险',
    securityRisk_critical: '严重风险',
    securityIssuesFound: '发现 {count} 个安全问题',
  ...
  en: {
    ...
    // Security scan
    securityScanTitle: 'Security Scan Report',
    securityRisk_safe: 'Safe',
    securityRisk_low: 'Low Risk',
    securityRisk_medium: 'Medium Risk',
    securityRisk_high: 'High Risk',
    securityRisk_critical: 'Critical Risk',
    securityIssuesFound: '{count} security issue(s) found',
